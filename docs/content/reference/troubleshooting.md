...
Most of these come down to network reality or how betterexplained serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

betterexplained rate-limits like any public site. be already paces
...
Where a surface is gated, be reads a cookie or token you supply
...
`be`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what be actually did
